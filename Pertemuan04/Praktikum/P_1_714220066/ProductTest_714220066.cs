...
{
    class ProductTest_714220066
    {
        static void Main(string[] args)
        {
            Book_714220066 product1 = new Book_714220066("Book", "C# Object Oriented Solution","300");
            DVD_714220066 product2 = new DVD_714220066("Ethernal Sunshine of The Spotless Mind", "145");
